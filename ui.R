    ...
    navbarPage("",
        ...
        tabPanel("SeqMaker",
            sidebarLayout(
                ...
                mainPanel(
                    HTML('<div class="bs-callout bs-callout-danger" id="callout-scrollspy-target-ids" style="margin-bottom: 10px;"><b>Note:</b> consensus sequences are generated by substituting variants based on the reference genome.</div>'),
